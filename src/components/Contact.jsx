...
// //     e.preventDefault();
// //     try {
// //       // TODO: send to your API/Formspree/EmailJS
...
// //     <section
// //       id="contact"
// //       className="bg-gray-900 text-white font-space px-6 py-16 scroll-mt-24"
// //     >
...
// //             className="bg-gray-800/50 border border-gray-700/60 rounded-2xl p-3 sm:p-3 space-y-2"
...
// //                   required
// //                   className="w-full rounded-xl bg-[#3a3a3a] text-white placeholder-slate-400 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-slate-300"
// //                 />
// //               </div>
// //               <div className="flex flex-col gap-2">
...
// //             <button
// //               type="submit"
// //               className="inline-flex items-center justify-center rounded-full bg-slate-400 text-black font-extrabold tracking-wide px-8 py-3 uppercase hover:bg-slate-300 active:translate-y-[1px] transition"
// //             >
// //               Submit
// //             </button>

// //             {status === "success" && (
// //               <p className="text-emerald-400">Thanks! Your message was sent.</p>
// //             )}
// //             {status === "error" && (
...
// //         {/* Centered location + copyright below both columns */}
